...
class Login(object):
    ...
    """
    def __init__(self, user_id=None, session_id=None, device_ip=None, origin_timestamp=None, login_status=None, custom_info=None):
        """
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this Login.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this Login.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this Login.
        ...
        :return: The session_id of this Login.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this Login.
        The user's current session ID, used to tie a user's action before and after login or account creation. Required if no user_id values is provided.

        :param session_id: The session_id of this Login.
        :type: str
        """
    ...
    def device_ip(self, device_ip):
        """
        Sets the device_ip of this Login.
        IP address of the request made by the user. Recommended for historical backfills and customers with mobile apps.

        :param device_ip: The device_ip of this Login.
        :type: str
        """
    ...
    def origin_timestamp(self, origin_timestamp):
        """
        Sets the origin_timestamp of this Login.
        Represents the time the event occured in your system. Send as a UNIX timestamp in milliseconds in string.

        :param origin_timestamp: The origin_timestamp of this Login.
        :type: str
        """
    ...
    def login_status(self, login_status):
        """
        Sets the login_status of this Login.
        Use _loginStatus to represent the success or failure of the login attempt. e.g. _success, _failure

        :param login_status: The login_status of this Login.
        :type: str
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this Login.

        :return: The custom_info of this Login.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this Login.

        :param custom_info: The custom_info of this Login.
        :type: CustomInfo
        """
