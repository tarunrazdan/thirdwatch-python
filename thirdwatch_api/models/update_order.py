...
class UpdateOrder(object):
    ...
    def __init__(self, user_id=None, session_id=None, order_id=None, device_ip=None, origin_timestamp=None, user_email=None, amount=None, currency_code=None, has_expedited_shipping=None, shipping_method=None, order_referrer=None, is_pre_paid=None, is_gift=None, is_return=None, is_first_time_buyer=None, billing_address=None, shipping_address=None, payment_methods=None, promotions=None, items=None, custom_info=None):
        """
        UpdateOrder - a model defined in Swagger
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this UpdateOrder.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this UpdateOrder.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this UpdateOrder.
        ...
        :return: The session_id of this UpdateOrder.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this UpdateOrder.
        The user's current session ID, used to tie a user's action before and after login or account creation. Required if no user_id values is provided.

        :param session_id: The session_id of this UpdateOrder.
        :type: str
        """
    ...
    def order_id(self):
        """
        Gets the order_id of this UpdateOrder.
        The ID for tracking this order in your system.

        :return: The order_id of this UpdateOrder.
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        """
        Sets the order_id of this UpdateOrder.
        The ID for tracking this order in your system.

        :param order_id: The order_id of this UpdateOrder.
        :type: str
        """
        if order_id is None:
    ...
    def device_ip(self, device_ip):
        """
        Sets the device_ip of this UpdateOrder.
        IP address of the request made by the user. Recommended for historical backfills and customers with mobile apps.

        :param device_ip: The device_ip of this UpdateOrder.
        :type: str
        """
    ...
    def origin_timestamp(self, origin_timestamp):
        """
        Sets the origin_timestamp of this UpdateOrder.
        Represents the time the event occured in your system. Send as a UNIX timestamp in milliseconds in string.

        :param origin_timestamp: The origin_timestamp of this UpdateOrder.
        :type: str
        """
    ...
    def user_email(self):
        """
        Gets the user_email of this UpdateOrder.
        ...
        :return: The user_email of this UpdateOrder.
        :rtype: str
        """
    ...
    def user_email(self, user_email):
        """
        Sets the user_email of this UpdateOrder.
        Email of the user creating this order. Note - If the user's email is also their account ID in your system, set both the userId and userEmail fields to their email address.

        :param user_email: The user_email of this UpdateOrder.
        :type: str
        """
    ...
    def amount(self, amount):
        """
        Sets the amount of this UpdateOrder.
        The item unit price in numbers, in the base unit of the currency_code.e.g. \"2500\"

        :param amount: The amount of this UpdateOrder.
        :type: str
        """
    ...
    def currency_code(self):
        """
        Gets the currency_code of this UpdateOrder.
        ...
        :return: The currency_code of this UpdateOrder.
        :rtype: str
        """
    ...
    def currency_code(self, currency_code):
        """
        Sets the currency_code of this UpdateOrder.
        The [ISO-4217](http://en.wikipedia.org/wiki/ISO_4217) currency code for the amount. e.g., USD, INR alternative currencies, like bitcoin or points systems.

        :param currency_code: The currency_code of this UpdateOrder.
        :type: str
        """
    ...
    def has_expedited_shipping(self):
        """
        Gets the has_expedited_shipping of this UpdateOrder.
        Whether the user requested priority/expedited shipping on their order.

        :return: The has_expedited_shipping of this UpdateOrder.
        :rtype: bool
        """
    ...
    def has_expedited_shipping(self, has_expedited_shipping):
        """
        Sets the has_expedited_shipping of this UpdateOrder.
        Whether the user requested priority/expedited shipping on their order.

        :param has_expedited_shipping: The has_expedited_shipping of this UpdateOrder.
        :type: bool
        """
    ...
    def shipping_method(self):
        """
        Gets the shipping_method of this UpdateOrder.
        Indicates the method of delivery to the user. e.g. _electronic, _physical

        :return: The shipping_method of this UpdateOrder.
        :rtype: str
        """
    ...
    def shipping_method(self, shipping_method):
        """
        Sets the shipping_method of this UpdateOrder.
        Indicates the method of delivery to the user. e.g. _electronic, _physical

        :param shipping_method: The shipping_method of this UpdateOrder.
        :type: str
        """
    ...
    def order_referrer(self):
        """
        Gets the order_referrer of this UpdateOrder.
        Referer website or user name.

        :return: The order_referrer of this UpdateOrder.
        :rtype: str
        """
    ...
    def order_referrer(self, order_referrer):
        """
        Sets the order_referrer of this UpdateOrder.
        Referer website or user name.

        :param order_referrer: The order_referrer of this UpdateOrder.
        :type: str
        """
    ...
    def is_pre_paid(self):
        """
        Gets the is_pre_paid of this UpdateOrder.
        is order is prepaid.

        :return: The is_pre_paid of this UpdateOrder.
        :rtype: bool
        """
    ...
    def is_pre_paid(self, is_pre_paid):
        """
        Sets the is_pre_paid of this UpdateOrder.
        is order is prepaid.

        :param is_pre_paid: The is_pre_paid of this UpdateOrder.
        :type: bool
        """
    ...
    def is_gift(self):
        """
        Gets the is_gift of this UpdateOrder.
        Is user chosen gift pack.

        :return: The is_gift of this UpdateOrder.
        :rtype: bool
        """
    ...
    def is_gift(self, is_gift):
        """
        Sets the is_gift of this UpdateOrder.
        Is user chosen gift pack.

        :param is_gift: The is_gift of this UpdateOrder.
        :type: bool
        """
    ...
    def is_return(self):
        """
        Gets the is_return of this UpdateOrder.
        Is this return order.

        :return: The is_return of this UpdateOrder.
        :rtype: bool
        """
    ...
    def is_return(self, is_return):
        """
        Sets the is_return of this UpdateOrder.
        Is this return order.

        :param is_return: The is_return of this UpdateOrder.
        :type: bool
        """
    ...
    def is_first_time_buyer(self):
        """
        Gets the is_first_time_buyer of this UpdateOrder.
        Is user first time buyer.

        :return: The is_first_time_buyer of this UpdateOrder.
        :rtype: bool
        """
    ...
    def is_first_time_buyer(self, is_first_time_buyer):
        """
        Sets the is_first_time_buyer of this UpdateOrder.
        Is user first time buyer.

        :param is_first_time_buyer: The is_first_time_buyer of this UpdateOrder.
        :type: bool
        """
    ...
    def billing_address(self):
        """
        Gets the billing_address of this UpdateOrder.

        :return: The billing_address of this UpdateOrder.
    ...
    def billing_address(self, billing_address):
        """
        Sets the billing_address of this UpdateOrder.

        :param billing_address: The billing_address of this UpdateOrder.
        :type: BillingAddress
        """
    ...
    def shipping_address(self):
        """
        Gets the shipping_address of this UpdateOrder.

        :return: The shipping_address of this UpdateOrder.
    ...
    def shipping_address(self, shipping_address):
        """
        Sets the shipping_address of this UpdateOrder.

        :param shipping_address: The shipping_address of this UpdateOrder.
    ...
    def payment_methods(self):
        """
        Gets the payment_methods of this UpdateOrder.
        ...
        :return: The payment_methods of this UpdateOrder.
    ...
    def payment_methods(self, payment_methods):
        """
        Sets the payment_methods of this UpdateOrder.
        The payment information associated with this order. Represented as an array of nested payment_method objects containing payment type, payment gateway, credit card bin, etc.

        :param payment_methods: The payment_methods of this UpdateOrder.
    ...
    def promotions(self):
        """
        Gets the promotions of this UpdateOrder.
        ...
        :return: The promotions of this UpdateOrder.
    ...
    def promotions(self, promotions):
        """
        Sets the promotions of this UpdateOrder.
        The list of promotions that apply to this order. You can add one or more promotions when creating or updating an order. Represented as a JSON array of promotion objects. You can also separately add promotions to the account via the addPromotion event.

        :param promotions: The promotions of this UpdateOrder.
        :type: list[Promotion]
        """
    ...
    def items(self):
        """
        Gets the items of this UpdateOrder.
        The list of items ordered. Represented as a JSON array of item

        :return: The items of this UpdateOrder.
        :rtype: list[Item]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this UpdateOrder.
        The list of items ordered. Represented as a JSON array of item

        :param items: The items of this UpdateOrder.
        :type: list[Item]
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this UpdateOrder.

        :return: The custom_info of this UpdateOrder.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this UpdateOrder.

        :param custom_info: The custom_info of this UpdateOrder.
        :type: CustomInfo
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UpdateOrder):
            return False
