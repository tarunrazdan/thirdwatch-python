...
class UnTag(object):
    ...
    """
    def __init__(self, user_id=None, abuse_type=None, analyst=None, custom_info=None):
        """
        UnTag - a model defined in Swagger
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this UnTag.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this UnTag.
        :type: str
        """
    ...
    def abuse_type(self):
        """
        Gets the abuse_type of this UnTag.
        ...
        :return: The abuse_type of this UnTag.
        :rtype: str
        """
    ...
    def abuse_type(self, abuse_type):
        """
        Sets the abuse_type of this UnTag.
        The type of abuse for which you want to untag user. It's important to send a untag specific to the type of abuse. You'll end up with more accurate results this way. e.g. _paymentAbuse, _contentAbuse, _promotionAbuse, _accountAbuse If you wants to untag from all type of abuses than don't send this parameter.

        :param abuse_type: The abuse_type of this UnTag.
        :type: str
        """
    ...
    def analyst(self, analyst):
        """
        Sets the analyst of this UnTag.
        Unique identifier (e.g. email address) of the analyst who applied the label. Useful for tracking purposes after the fact.

        :param analyst: The analyst of this UnTag.
        :type: str
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this UnTag.

        :return: The custom_info of this UnTag.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this UnTag.

        :param custom_info: The custom_info of this UnTag.
        :type: CustomInfo
        """
