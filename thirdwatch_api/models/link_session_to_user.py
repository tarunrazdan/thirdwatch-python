...
class LinkSessionToUser(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, user_id=None, session_id=None, custom_info=None):
        """
        LinkSessionToUser - a model defined in Swagger
    ...
    def user_id(self):
        """
        Gets the user_id of this LinkSessionToUser.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :return: The user_id of this LinkSessionToUser.
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this LinkSessionToUser.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this LinkSessionToUser.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this LinkSessionToUser.
        The user's current session ID, used to associate session id with user id.

        :return: The session_id of this LinkSessionToUser.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this LinkSessionToUser.
        The user's current session ID, used to associate session id with user id.

        :param session_id: The session_id of this LinkSessionToUser.
        :type: str
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this LinkSessionToUser.

        :return: The custom_info of this LinkSessionToUser.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this LinkSessionToUser.

        :param custom_info: The custom_info of this LinkSessionToUser.
        :type: CustomInfo
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LinkSessionToUser):
            return False
