...
class ReportItem(object):
    ...
    """
    def __init__(self, user_id=None, session_id=None, item_id=None, device_ip=None, origin_timestamp=None, user_email=None, custom_info=None):
        """
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this ReportItem.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this ReportItem.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this ReportItem.
        ...
        :return: The session_id of this ReportItem.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this ReportItem.
        The user's current session ID, used to tie a user's action before and after login or account creation. Required if no user_id values is provided.

        :param session_id: The session_id of this ReportItem.
        :type: str
        """
    ...
    def item_id(self, item_id):
        """
        Sets the item_id of this ReportItem.
        The unique ID for the item that is being reported. Note - item IDs are case sensitive.

        :param item_id: The item_id of this ReportItem.
        :type: str
        """
    ...
    def device_ip(self, device_ip):
        """
        Sets the device_ip of this ReportItem.
        IP address of the request made by the user. Recommended for historical backfills and customers with mobile apps.

        :param device_ip: The device_ip of this ReportItem.
        :type: str
        """
    ...
    def origin_timestamp(self, origin_timestamp):
        """
        Sets the origin_timestamp of this ReportItem.
        Represents the time the event occured in your system. Send as a UNIX timestamp in milliseconds in string.

        :param origin_timestamp: The origin_timestamp of this ReportItem.
        :type: str
        """
    ...
    def user_email(self):
        """
        Gets the user_email of this ReportItem.
        ...
        :return: The user_email of this ReportItem.
        :rtype: str
        """
    ...
    def user_email(self, user_email):
        """
        Sets the user_email of this ReportItem.
        Email of the user creating this order. Note - If the user's email is also their account ID in your system, set both the userId and userEmail fields to their email address.

        :param user_email: The user_email of this ReportItem.
        :type: str
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this ReportItem.

        :return: The custom_info of this ReportItem.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this ReportItem.

        :param custom_info: The custom_info of this ReportItem.
        :type: CustomInfo
        """
