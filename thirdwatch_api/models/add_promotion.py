...
class AddPromotion(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, user_id=None, session_id=None, device_ip=None, origin_timestamp=None, promotions=None, custom_info=None):
        """
        AddPromotion - a model defined in Swagger
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this AddPromotion.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this AddPromotion.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this AddPromotion.
        ...
        :return: The session_id of this AddPromotion.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this AddPromotion.
        The user's current session ID, used to tie a user's action before and after login or account creation. Required if no user_id values is provided.

        :param session_id: The session_id of this AddPromotion.
        :type: str
        """
    ...
    def device_ip(self, device_ip):
        """
        Sets the device_ip of this AddPromotion.
        IP address of the request made by the user. Recommended for historical backfills and customers with mobile apps.

        :param device_ip: The device_ip of this AddPromotion.
        :type: str
        """
    ...
    def origin_timestamp(self, origin_timestamp):
        """
        Sets the origin_timestamp of this AddPromotion.
        Represents the time the event occured in your system. Send as a UNIX timestamp in milliseconds in string.

        :param origin_timestamp: The origin_timestamp of this AddPromotion.
        :type: str
        """
    ...
    def promotions(self):
        """
        Gets the promotions of this AddPromotion.
        Contains all promotions that have been newly applied to the referenced user.

        :return: The promotions of this AddPromotion.
    ...
    def promotions(self, promotions):
        """
        Sets the promotions of this AddPromotion.
        Contains all promotions that have been newly applied to the referenced user.

        :param promotions: The promotions of this AddPromotion.
        :type: list[Promotion]
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this AddPromotion.

        :return: The custom_info of this AddPromotion.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this AddPromotion.

        :param custom_info: The custom_info of this AddPromotion.
        :type: CustomInfo
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AddPromotion):
            return False
