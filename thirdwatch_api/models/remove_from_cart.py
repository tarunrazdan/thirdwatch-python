...
class RemoveFromCart(object):
    ...
    def __init__(self, user_id=None, session_id=None, device_ip=None, origin_timestamp=None, item=None, custom_info=None):
        """
        RemoveFromCart - a model defined in Swagger
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this RemoveFromCart.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this RemoveFromCart.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this RemoveFromCart.
        ...
        :return: The session_id of this RemoveFromCart.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this RemoveFromCart.
        The user's current session ID, used to tie a user's action before and after login or account creation. Required if no user_id values is provided.

        :param session_id: The session_id of this RemoveFromCart.
        :type: str
        """
    ...
    def device_ip(self, device_ip):
        """
        Sets the device_ip of this RemoveFromCart.
        IP address of the request made by the user. Recommended for historical backfills and customers with mobile apps.

        :param device_ip: The device_ip of this RemoveFromCart.
        :type: str
        """
    ...
    def origin_timestamp(self, origin_timestamp):
        """
        Sets the origin_timestamp of this RemoveFromCart.
        Represents the time the event occured in your system. Send as a UNIX timestamp in milliseconds in string.

        :param origin_timestamp: The origin_timestamp of this RemoveFromCart.
        :type: str
        """
    ...
    def item(self):
        """
        Gets the item of this RemoveFromCart.

        :return: The item of this RemoveFromCart.
        :rtype: Item
        """
        return self._item
    ...
    def item(self, item):
        """
        Sets the item of this RemoveFromCart.

        :param item: The item of this RemoveFromCart.
        :type: Item
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this RemoveFromCart.

        :return: The custom_info of this RemoveFromCart.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this RemoveFromCart.

        :param custom_info: The custom_info of this RemoveFromCart.
        :type: CustomInfo
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RemoveFromCart):
            return False
