...
class SendMessage(object):
    ...
    """
    def __init__(self, user_id=None, session_id=None, device_ip=None, origin_timestamp=None, recipient_user_id=None, subject=None, content=None, custom_info=None):
        """
        SendMessage - a model defined in Swagger
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this SendMessage.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this SendMessage.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this SendMessage.
        ...
        :return: The session_id of this SendMessage.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this SendMessage.
        The user's current session ID, used to tie a user's action before and after login or account creation. Required if no user_id values is provided.

        :param session_id: The session_id of this SendMessage.
        :type: str
        """
    ...
    def device_ip(self, device_ip):
        """
        Sets the device_ip of this SendMessage.
        IP address of the request made by the user. Recommended for historical backfills and customers with mobile apps.

        :param device_ip: The device_ip of this SendMessage.
        :type: str
        """
    ...
    def origin_timestamp(self, origin_timestamp):
        """
        Sets the origin_timestamp of this SendMessage.
        Represents the time the event occured in your system. Send as a UNIX timestamp in milliseconds in string.

        :param origin_timestamp: The origin_timestamp of this SendMessage.
        :type: str
        """
    ...
    def recipient_user_id(self):
        """
        Gets the recipient_user_id of this SendMessage.
        _userID of the receiving user by default Store.

        :return: The recipient_user_id of this SendMessage.
        :rtype: str
        """
    ...
    def recipient_user_id(self, recipient_user_id):
        """
        Sets the recipient_user_id of this SendMessage.
        _userID of the receiving user by default Store.

        :param recipient_user_id: The recipient_user_id of this SendMessage.
        :type: str
        """
    ...
    def subject(self):
        """
        Gets the subject of this SendMessage.
        The subject of the message.

        :return: The subject of this SendMessage.
        :rtype: str
        """
    ...
    def subject(self, subject):
        ...
        :param subject: The subject of this SendMessage.
        :type: str
        """
    ...
    def content(self):
        """
        Gets the content of this SendMessage.
        The text content of the message.

        :return: The content of this SendMessage.
        :rtype: str
        """
    ...
    def content(self, content):
        """
        Sets the content of this SendMessage.
        The text content of the message.

        :param content: The content of this SendMessage.
        :type: str
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this SendMessage.

        :return: The custom_info of this SendMessage.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this SendMessage.

        :param custom_info: The custom_info of this SendMessage.
        :type: CustomInfo
        """
