...
class CreateAccount(object):
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this CreateAccount.
        The user's account ID according to your systems. Note that user IDs are case sensitive.

        :param user_id: The user_id of this CreateAccount.
        :type: str
        """
    ...
    def session_id(self):
        """
        Gets the session_id of this CreateAccount.
        ...
        :return: The session_id of this CreateAccount.
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """
        Sets the session_id of this CreateAccount.
        The user's current session ID, used to tie a user's action before and after login or account creation. Required if no user_id values is provided.

        :param session_id: The session_id of this CreateAccount.
        :type: str
        """
    ...
    def device_ip(self, device_ip):
        """
        Sets the device_ip of this CreateAccount.
        IP address of the request made by the user. Recommended for historical backfills and customers with mobile apps.

        :param device_ip: The device_ip of this CreateAccount.
        :type: str
        """
    ...
    def origin_timestamp(self, origin_timestamp):
        """
        Sets the origin_timestamp of this CreateAccount.
        Represents the time the event occured in your system. Send as a UNIX timestamp in milliseconds in string.

        :param origin_timestamp: The origin_timestamp of this CreateAccount.
        :type: str
        """
    ...
    def user_email(self):
        """
        Gets the user_email of this CreateAccount.
        ...
        :return: The user_email of this CreateAccount.
        :rtype: str
        """
    ...
    def user_email(self, user_email):
        """
        Sets the user_email of this CreateAccount.
        Email of the user creating this order. Note - If the user's email is also their account ID in your system, set both the userId and userEmail fields to their email address.

        :param user_email: The user_email of this CreateAccount.
        :type: str
        """
    ...
    def first_name(self):
        """
        Gets the first_name of this CreateAccount.
        Provide the first name associated with the user here.

        :return: The first_name of this CreateAccount.
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """
        Sets the first_name of this CreateAccount.
        Provide the first name associated with the user here.

        :param first_name: The first_name of this CreateAccount.
        :type: str
        """
    ...
    def last_name(self):
        """
        Gets the last_name of this CreateAccount.
        Provide the last name associated with the user here.

        :return: The last_name of this CreateAccount.
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """
        Sets the last_name of this CreateAccount.
        Provide the last name associated with the user here.

        :param last_name: The last_name of this CreateAccount.
        :type: str
        """
    ...
    def phone(self, phone):
        ...
        :param phone: The phone of this CreateAccount.
        :type: str
        """
    ...
    def age(self):
        """
        Gets the age of this CreateAccount.
        Age of the user e.g. \"25\"

        :return: The age of this CreateAccount.
        :rtype: str
        """
        return self._age
    ...
    def age(self, age):
        """
        Sets the age of this CreateAccount.
        Age of the user e.g. \"25\"

        :param age: The age of this CreateAccount.
        :type: str
        """
    ...
    def gender(self):
        """
        Gets the gender of this CreateAccount.
        Gender of the user e.g. \"_male\", \"_female\" or \"_trans\"

        :return: The gender of this CreateAccount.
        :rtype: str
        """
        return self._gender
    ...
    def gender(self, gender):
        """
        Sets the gender of this CreateAccount.
        Gender of the user e.g. \"_male\", \"_female\" or \"_trans\"

        :param gender: The gender of this CreateAccount.
        :type: str
        """
    ...
    def referral_code(self):
        """
        Gets the referral_code of this CreateAccount.
        Code or promotion used by the user while creating account.

        :return: The referral_code of this CreateAccount.
        :rtype: str
        """
    ...
    def referral_code(self, referral_code):
        """
        Sets the referral_code of this CreateAccount.
        Code or promotion used by the user while creating account.

        :param referral_code: The referral_code of this CreateAccount.
        :type: str
        """
    ...
    def referrer_user_id(self, referrer_user_id):
        """
        Sets the referrer_user_id of this CreateAccount.
        The ID of the user that referred the current user to your business. This field is required for detecting referral fraud.

        :param referrer_user_id: The referrer_user_id of this CreateAccount.
        :type: str
        """
    ...
    def billing_address(self):
        """
        Gets the billing_address of this CreateAccount.

        :return: The billing_address of this CreateAccount.
    ...
    def billing_address(self, billing_address):
        """
        Sets the billing_address of this CreateAccount.

        :param billing_address: The billing_address of this CreateAccount.
        :type: BillingAddress
        """
    ...
    def shipping_address(self):
        """
        Gets the shipping_address of this CreateAccount.

        :return: The shipping_address of this CreateAccount.
    ...
    def shipping_address(self, shipping_address):
        """
        Sets the shipping_address of this CreateAccount.

        :param shipping_address: The shipping_address of this CreateAccount.
    ...
    def payment_methods(self):
        """
        Gets the payment_methods of this CreateAccount.
        ...
        :return: The payment_methods of this CreateAccount.
    ...
    def payment_methods(self, payment_methods):
        """
        Sets the payment_methods of this CreateAccount.
        The payment information associated with this account. Represented as an array of nested payment_method objects containing payment type, payment gateway, credit card bin, etc.

        :param payment_methods: The payment_methods of this CreateAccount.
    ...
    def promotions(self):
        """
        Gets the promotions of this CreateAccount.
        ...
        :return: The promotions of this CreateAccount.
    ...
    def promotions(self, promotions):
        """
        Sets the promotions of this CreateAccount.
        The list of promotions that apply to this account. You can add one or more promotions when creating or updating an order. Represented as a JSON array of promotion objects. You can also separately add promotions to the account via the addPromotion event.

        :param promotions: The promotions of this CreateAccount.
        :type: list[Promotion]
        """
    ...
    def social_sign_on_type(self, social_sign_on_type):
        """
        Sets the social_sign_on_type of this CreateAccount.
        If the user logged in with a social identify provider, give the name here. e.g. _google, _facebook, _twitter, _linkedin, _other

        :param social_sign_on_type: The social_sign_on_type of this CreateAccount.
        :type: str
        """
    ...
    def email_confirmed_status(self):
        """
        Gets the email_confirmed_status of this CreateAccount.
        Status of email verification. e.g. _success, _failure, _pending

        :return: The email_confirmed_status of this CreateAccount.
        :rtype: str
        """
    ...
    def email_confirmed_status(self, email_confirmed_status):
        """
        Sets the email_confirmed_status of this CreateAccount.
        Status of email verification. e.g. _success, _failure, _pending

        :param email_confirmed_status: The email_confirmed_status of this CreateAccount.
        :type: str
        """
    ...
    def phone_confirmed_status(self):
        """
        Gets the phone_confirmed_status of this CreateAccount.
        Status of phone verification. e.g. _success, _failure, _pending

        :return: The phone_confirmed_status of this CreateAccount.
        :rtype: str
        """
    ...
    def phone_confirmed_status(self, phone_confirmed_status):
        """
        Sets the phone_confirmed_status of this CreateAccount.
        Status of phone verification. e.g. _success, _failure, _pending

        :param phone_confirmed_status: The phone_confirmed_status of this CreateAccount.
        :type: str
        """
    ...
    def is_newsletter_subscribed(self):
        """
        Gets the is_newsletter_subscribed of this CreateAccount.
        Is user subscribed for newsletter. e.g. true, false

        :return: The is_newsletter_subscribed of this CreateAccount.
        :rtype: bool
        """
    ...
    def is_newsletter_subscribed(self, is_newsletter_subscribed):
        """
        Sets the is_newsletter_subscribed of this CreateAccount.
        Is user subscribed for newsletter. e.g. true, false

        :param is_newsletter_subscribed: The is_newsletter_subscribed of this CreateAccount.
        :type: bool
        """
    ...
    def account_status(self):
        """
        Gets the account_status of this CreateAccount.
        Current status of account, e.g. _active, _inactive

        :return: The account_status of this CreateAccount.
        :rtype: str
        """
    ...
    def account_status(self, account_status):
        """
        Sets the account_status of this CreateAccount.
        Current status of account, e.g. _active, _inactive

        :param account_status: The account_status of this CreateAccount.
        :type: str
        """
    ...
    def facebook_id(self):
        """
        Gets the facebook_id of this CreateAccount.
        Facebook user id or token of the user. This can help to varify his social identity.

        :return: The facebook_id of this CreateAccount.
        :rtype: str
        """
    ...
    def facebook_id(self, facebook_id):
        """
        Sets the facebook_id of this CreateAccount.
        Facebook user id or token of the user. This can help to varify his social identity.

        :param facebook_id: The facebook_id of this CreateAccount.
        :type: str
        """
    ...
    def google_id(self):
        """
        Gets the google_id of this CreateAccount.
        Google user id or token of the user. This can help to varify his social identity.

        :return: The google_id of this CreateAccount.
        :rtype: str
        """
    ...
    def google_id(self, google_id):
        """
        Sets the google_id of this CreateAccount.
        Google user id or token of the user. This can help to varify his social identity.

        :param google_id: The google_id of this CreateAccount.
        :type: str
        """
    ...
    def twitter_id(self):
        """
        Gets the twitter_id of this CreateAccount.
        Twitter handle or token of the user. This can help to varify his social identity.

        :return: The twitter_id of this CreateAccount.
        :rtype: str
        """
    ...
    def twitter_id(self, twitter_id):
        """
        Sets the twitter_id of this CreateAccount.
        Twitter handle or token of the user. This can help to varify his social identity.

        :param twitter_id: The twitter_id of this CreateAccount.
        :type: str
        """
    ...
    def custom_info(self):
        """
        Gets the custom_info of this CreateAccount.

        :return: The custom_info of this CreateAccount.
        :rtype: CustomInfo
        """
    ...
    def custom_info(self, custom_info):
        """
        Sets the custom_info of this CreateAccount.

        :param custom_info: The custom_info of this CreateAccount.
        :type: CustomInfo
        """
