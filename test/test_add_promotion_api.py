...
from thirdwatch_api.apis.add_promotion_api import AddPromotionApi


class TestAddPromotionApi(unittest.TestCase):
    """ AddPromotionApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.add_promotion_api.AddPromotionApi()
