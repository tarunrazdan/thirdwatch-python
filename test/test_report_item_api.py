...
from thirdwatch_api.apis.report_item_api import ReportItemApi


class TestReportItemApi(unittest.TestCase):
    """ ReportItemApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.report_item_api.ReportItemApi()
