...
from thirdwatch_api.models.link_session_to_user import LinkSessionToUser


class TestLinkSessionToUser(unittest.TestCase):
    """ LinkSessionToUser unit test stubs """
    ...
    def testLinkSessionToUser(self):
        """
        Test LinkSessionToUser
        """
        model = thirdwatch_api.models.link_session_to_user.LinkSessionToUser()
