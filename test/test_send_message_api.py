...
from thirdwatch_api.apis.send_message_api import SendMessageApi


class TestSendMessageApi(unittest.TestCase):
    """ SendMessageApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.send_message_api.SendMessageApi()
