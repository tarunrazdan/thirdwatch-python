...
from thirdwatch_api.apis.create_account_api import CreateAccountApi


class TestCreateAccountApi(unittest.TestCase):
    """ CreateAccountApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.create_account_api.CreateAccountApi()
