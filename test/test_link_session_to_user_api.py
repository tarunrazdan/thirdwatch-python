...
from thirdwatch_api.apis.link_session_to_user_api import LinkSessionToUserApi


class TestLinkSessionToUserApi(unittest.TestCase):
    """ LinkSessionToUserApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.link_session_to_user_api.LinkSessionToUserApi()
    ...
    def test_link_session_to_user(self):
        """
        Test case for link_session_to_user
