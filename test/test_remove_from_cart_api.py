...
from thirdwatch_api.apis.remove_from_cart_api import RemoveFromCartApi


class TestRemoveFromCartApi(unittest.TestCase):
    """ RemoveFromCartApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.remove_from_cart_api.RemoveFromCartApi()
