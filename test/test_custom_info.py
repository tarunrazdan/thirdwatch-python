...
from thirdwatch_api.models.custom_info import CustomInfo


class TestCustomInfo(unittest.TestCase):
    """ CustomInfo unit test stubs """
    ...
    def testCustomInfo(self):
        """
        Test CustomInfo
        """
        model = thirdwatch_api.models.custom_info.CustomInfo()
