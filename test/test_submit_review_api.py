...
from thirdwatch_api.apis.submit_review_api import SubmitReviewApi


class TestSubmitReviewApi(unittest.TestCase):
    """ SubmitReviewApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.submit_review_api.SubmitReviewApi()
