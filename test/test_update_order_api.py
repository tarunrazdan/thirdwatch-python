...
from thirdwatch_api.apis.update_order_api import UpdateOrderApi


class TestUpdateOrderApi(unittest.TestCase):
    """ UpdateOrderApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.update_order_api.UpdateOrderApi()
