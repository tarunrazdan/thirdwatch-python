...
from thirdwatch_api.models.add_promotion import AddPromotion


class TestAddPromotion(unittest.TestCase):
    """ AddPromotion unit test stubs """
    ...
    def testAddPromotion(self):
        """
        Test AddPromotion
        """
        model = thirdwatch_api.models.add_promotion.AddPromotion()
