...
from thirdwatch_api.apis.update_account_api import UpdateAccountApi


class TestUpdateAccountApi(unittest.TestCase):
    """ UpdateAccountApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.update_account_api.UpdateAccountApi()
