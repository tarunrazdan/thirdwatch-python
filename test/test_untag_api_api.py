...
from thirdwatch_api.apis.untag_api_api import UntagAPIApi


class TestUntagAPIApi(unittest.TestCase):
    """ UntagAPIApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.untag_api_api.UntagAPIApi()

    def tearDown(self):
        pass

    def test_un_tag_user(self):
        """
        Test case for un_tag_user
