...
from thirdwatch_api.apis.custom_event_api import CustomEventApi


class TestCustomEventApi(unittest.TestCase):
    """ CustomEventApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.custom_event_api.CustomEventApi()
