...
from thirdwatch_api.apis.create_order_api import CreateOrderApi


class TestCreateOrderApi(unittest.TestCase):
    """ CreateOrderApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.create_order_api.CreateOrderApi()
