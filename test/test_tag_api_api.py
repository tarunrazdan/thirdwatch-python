...
from thirdwatch_api.apis.tag_api_api import TagAPIApi


class TestTagAPIApi(unittest.TestCase):
    """ TagAPIApi unit test stubs """

    def setUp(self):
        self.api = thirdwatch_api.apis.tag_api_api.TagAPIApi()
